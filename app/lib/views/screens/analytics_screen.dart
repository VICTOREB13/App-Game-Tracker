...
class AnalyticsScreen extends StatefulWidget {
  ...
  const AnalyticsScreen({super.key, this.controller});
...
class _AnalyticsScreenState extends State<AnalyticsScreen> {
  ...
  List<Game> get _games => _controller.games;
  bool get _isLoading => _controller.isLoading;
  int get _selectedYear => _controller.selectedYear;
  int get _annualGoal => _controller.annualGoal;
  ...
  void initState() {
    ...
    unawaited(_controller.loadAnalytics());
  }
  ...
  Future<void> _setYearGoal(int newGoal) async {
    await _controller.setAnnualGoal(newGoal);
  }
  ...
  Color _getStatusColor(String status) => StatusHelper.getColor(status);
