...
A diferencia de soluciones dependientes de la nube lenta o bases de datos de terceros, la versión **v3.0.5** adopta una arquitectura **100% Local-First** impulsada por **SQLite** con límites defensivos de optimización de memoria, servicio nativo de HowLongToBeat, selector visual de plataformas, CRUD integral con borrado de campos opcionales, privacidad total y funcionamiento offline continuo en **Windows (PC)** y **Android**.
